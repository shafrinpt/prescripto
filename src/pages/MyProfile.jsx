...
const MyProfile = () => {
    ...
    const [userData, setUserData] = useState({
        ...
        email: 'shafrinptfathima@gamil.com',
        phone: '+91 8877668890',
        address: {
            line1: 'Tirur, Malappuram',
            line2: 'Paravoor, Kochi, Kerala',
        },
        gender: 'Female',
        dob: '1998-06-05'
    })
    ...
    return (
        <div className='max-w-lg flex flex-col gap-2 text-sm'>
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
                    ...
                    {isEdit
                        ...
                        : <p className='text-red-400'>{userData.phone}</p>}
            ...
            <div className='mt-10'>
                {
                    isEdit
                        ? <button onClick={() => setIsEdit(false)} className='border border-red-400 px-8 py-2 rounded-full hover:bg-red-400 hover:text-white transition-all'>Save information</button>
                        : <button onClick={() => setIsEdit(true)} className='border border-red-400 px-8 py-2 rounded-full hover:bg-red-400 hover:text-white transition-all'>Edit</button>
                }
            </div>
        </div>
    )
